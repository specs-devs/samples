...
[EntryPointMain.ts](./Assets/Scripts/EntryPointMain/EntryPointMain.ts) - Entry point for the lens: initializes high-five flow and coordinates the connected multiplayer scripts in the project.
