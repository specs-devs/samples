...
Before using any Specs Mobile Kit features, your app must
explicitly request
...
The main entry point for working with the Specs Mobile Kit. It
manages bonding and session setup between your app and Specs.
```Kotlin
...
open class ClientException(
    ...
    /**
     * Exception thrown when the Specs app is not installed.
     */
    class SpectaclesAppNotInstalled(message: String): ClientException(message)

    /**
     * Exception thrown when the Specs app is not enabled.
     */
    class SpectaclesAppNotEnabled(message: String): ClientException(message)

    /**
     * Exception thrown when the Specs app needs to be updated.
     */
...
```
Allows connections to unfused (debug) Specs.
...
val version: String?
```
The version of the asset currently cached on Specs (if any).  
...
Indicates that the cached version of the asset on Specs is current
...
Exception thrown when a request to the Specs fails.
