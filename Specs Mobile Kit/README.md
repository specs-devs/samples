...
<img src="./README-ref/sample-list-mobile-kit-rounded-edges.gif" alt="Specs Mobile Kit" width="500" />

## Overview

Specs Mobile Kit is a SDK that enables seamless communication between mobile applications and Lenses running on Specs via Bluetooth Low Energy (BLE). This sample demonstrates how to establish a secure session, send one-way data, perform request-response exchanges, subscribe to topics, and load remote textures and meshes from a companion mobile app. Learn more about the Specs Mobile Kit in the [official documentation](https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-mobile-kit/getting-started).
...
The bonding flow must be completed once via the Specs App before a session can be established.
...
3. Open the **Preview Panel** and select the Specs preview mode.
...
1. Click **Preview Lens** in Lens Studio to install and launch the Lens on your Specs.
2. Launch the companion mobile app on your phone:
   - **iOS**: Tap **SpectaclesKit bind**, grant Bluetooth access, approve the bond in the Specs App, then tap **Start Session**.
   - **Android**: Tap the **+** button, approve permissions and the bond in the Specs App — the app connects automatically.
