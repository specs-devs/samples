...
final class HandshakeRecordCodingTests: XCTestCase {
    func testCodings() throws {
        ...
        let testCases: [(HandshakeRecord, Data)] = [
            ...
            (
                .authenticationShare(shareData: .iosDeviceCheck(
                    publicKey: chunk1,
                    attestationObject: chunk2,
                    appId: "com.snap.test"
                )),
                Data([0x0B, 0x02, 0x20]) + chunk1 + Data([0x20]) + chunk2
                    + Data([0x0D]) + "com.snap.test".data(using: .utf8)!
            ),
