...
struct RootSecret<H: HashFunction> {
    ...
    func expandPeerSecrets(type: SecretType, transcriptHash: some ContiguousBytes) -> PeerTrafficSecrets<H> {
...
typealias PeerTrafficSecrets<H: HashFunction> = (clientSecret: PeerTrafficSecret<H>, serverSecret: PeerTrafficSecret<H>)
