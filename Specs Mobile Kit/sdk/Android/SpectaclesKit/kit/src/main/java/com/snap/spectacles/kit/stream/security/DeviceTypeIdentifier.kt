...
internal object DeviceTypeIdentifier {
    ...
    private const val SPECTACLES_V6_PUBLIC_KEY = """
    ...
    private const val SPECTACLES_V6_UNFUSED_PUBLIC_KEY = """
    ...
    private const val SPECTACLES_V7_PUBLIC_KEY = """
        MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAED0ZHe5NKMKxEHo1/WR+qpT9efy4w
        hidmSTTzi2CHkPxy22fy8gi9uFW9xPRen2ay4WHYjQcnBSOSAFVQ26iL4Q==
    """

    private const val SPECTACLES_V7_UNFUSED_PUBLIC_KEY = """
        MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEZ7RyX/csvC+8oqUnJ/l0AfrqRBJC
        mmKr1cLgLpmVg26a9u7IB+5ObdMDnC7BL+LcWV5zS94KIR0ZPbEYDf7Agg==
    """
    ...
    private val devicePublicKeyToType by lazy {
        listOf(
            SPECTACLES_V7_PUBLIC_KEY.encoded() to SpectaclesStreamTrustManager.DeviceType.SPECTACLES,
            SPECTACLES_V7_UNFUSED_PUBLIC_KEY.encoded() to SpectaclesStreamTrustManager.DeviceType.SPECTACLES_UNFUSED,
            SPECTACLES_V6_PUBLIC_KEY.encoded() to SpectaclesStreamTrustManager.DeviceType.SPECTACLES,
            SPECTACLES_V6_UNFUSED_PUBLIC_KEY.encoded() to SpectaclesStreamTrustManager.DeviceType.SPECTACLES_UNFUSED,
