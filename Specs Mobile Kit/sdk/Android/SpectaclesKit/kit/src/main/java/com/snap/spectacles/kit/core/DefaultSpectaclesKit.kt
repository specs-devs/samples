...
class DefaultSpectaclesKit(
    ...
    companion object {
        ...
        /**
         * Creates a builder for the latest Spectacles models.
         * @param context The application context.
         * @param legacy Indicates whether to support legacy Spectacles (running on Snap OS 2.0).
         */
        fun newBuilder(
            context: Context,
            legacy: Boolean = true,
        ): SpectaclesKit.Builder =
            DefaultSpectaclesKitBuilder(context, legacy)
    }
...
private class DefaultSpectaclesKitBuilder(
    ...
    override fun build(): SpectaclesKit {
        return DefaultSpectaclesKit(
            ...
            executor = executor,
            dependencies = DefaultKitDependencies(context, legacy),
        )
    }
}
