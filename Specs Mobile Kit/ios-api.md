...
<th>The deeplink for passing the bonding result from Specs App back
...
<tr>
<th>deeplinkAsyncStream</th>
<th>The deeplink for passing the unbinding result from Specs App
...
Specs Mobile Kit. It provides a unified representation of all
...
<th>A request that expects a stream-based response from Specs. The
...
```
Specs Mobile Kit utilizes a logger instance to record events. You
