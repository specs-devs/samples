...
export class TextInputManager extends BaseScriptComponent {
  ...
  public onKeyboardStateChanged: PublicApi<boolean> = this.onKeyboardStateChangedEvent.publicApi()

  static getInstance(): TextInputManager {
    if (this.instance) {
      return this.instance
    } else {
      throw new Error("TextInputManager instance not initialized. Please ensure it is added to a scene object.")
    }
  }
