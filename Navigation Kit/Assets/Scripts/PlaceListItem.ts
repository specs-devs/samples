...
export class PlaceListItem extends BaseScriptComponent {
  ...
  public initialize(
    ...
    const arrivedAtPlaceUnsubscribe = navigationComponent.onArrivedAtPlace.add((place) => this.arriveAtPlace(place))
    const navigationStartedUnsubscribe = navigationComponent.onNavigationStarted.add((place) =>
