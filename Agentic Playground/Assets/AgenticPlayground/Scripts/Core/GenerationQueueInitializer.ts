...
export class GenerationQueueInitializer extends BaseScriptComponent {
  ...
  onAwake() {
    if (this.enableQueueSystem) {
      ...
      print("GenerationQueueInitializer: Queue system disabled by configuration")
    }
  }
  ...
  private initializeQueue(): void {
    ...
    if (this.imageGenFactory) {
      ...
      if (this.enableDebugLogging) {
        print("GenerationQueueInitializer: No ImageGen factory assigned")
      }
    }
    ...
    if (this.modelGenFactory) {
      ...
      if (this.enableDebugLogging) {
        print("GenerationQueueInitializer: No ModelGen factory assigned")
      }
    }
