...
export class MindMapSpatialUtils {
   ...
   */
  public static calculateCircularPositions(
    centerPosition: vec3,
    radius: number,
    nodeCount: number,
    startAngle: number = 0
   ...
   */
  public static calculateSpiralPositions(
    centerPosition: vec3,
    innerRadius: number,
    outerRadius: number,
    nodeCount: number,
   ...
   */
  public static calculateRadialTreePositions(
    centerPosition: vec3,
    levels: number,
   ...
   */
  public static findNonCollidingPosition(
   ...
   */
  public static distributeBezierPositions(
    startPos: vec3,
    controlPos1: vec3,
    controlPos2: vec3,
    endPos: vec3,
   ...
   */
  public static applyForceDirectedLayout(
    positions: vec3[],
    connections: number[][],
    iterations: number = 50,
    repulsionForce: number = 100,
   ...
   */
  public static smoothTransition(
    startPos: vec3,
    endPos: vec3,
    progress: number,
