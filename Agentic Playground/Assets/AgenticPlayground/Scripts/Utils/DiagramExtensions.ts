...
export class DiagramExtensions {
  ...
  public static getDiagramStatus(diagram: DiagramComponent): {
    ...
    try {
      ...
      let imageNodes = 0
      let modelNodes = 0
      const startingNodes = status.nodesByLevel.get(0) || 0 // Starting nodes are at level 0
