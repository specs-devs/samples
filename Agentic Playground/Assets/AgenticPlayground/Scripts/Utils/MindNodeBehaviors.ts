...
export class ModelNodeBehavior extends BaseMindNodeBehavior {
  ...
  private animateEntry(): void {
    ...
    const animate = () => {
      ...
      const bounceProgress = progress < 0.5 ? 2 * progress * progress : 1 - Math.pow(-2 * progress + 2, 3) / 2
...
export class MindNodeBehaviorFactory {
  public static createStartingNodeBehavior(
    sceneObject: SceneObject,
    nodeId: string,
    diagramName: string
  ): StartingNodeBehavior {
    return new StartingNodeBehavior(sceneObject, nodeId, diagramName)
  }

  public static createTextNodeBehavior(
    sceneObject: SceneObject,
    nodeId: string,
    textContent: string
  ): TextNodeBehavior {
  ...
  public static createImageNodeBehavior(
    sceneObject: SceneObject,
    nodeId: string,
    textContent: string,
    imagePath: string
  ...
  public static createModelNodeBehavior(
    sceneObject: SceneObject,
    nodeId: string,
    textContent: string,
    modelPath: string
