...
**Example Service URL:** `https://your-railway-service.up.railway.app` (Generated by Railway)
...
- Port: **8080**
- Domain generated: `your-service-name.up.railway.app`
...
### Health Check
```bash
GET https://your-railway-service.up.railway.app/health
```
