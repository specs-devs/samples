...
**Repository:** Your GitHub repository (e.g., `https://github.com/YOUR_USERNAME/composite-stitcher`)
...
**Stitch Video:**
```bash
POST https://your-railway-service.up.railway.app/stitch
...
3. **Deployed Function:**
   ...
   export SUPABASE_ACCESS_TOKEN="your_supabase_cli_token_here"
   supabase functions deploy trigger-composite-stitch --project-ref your_project_ref
   ```

4. **Set Environment Secret:**
   ```bash
   supabase secrets set STITCHER_SERVICE_URL=https://your-railway-service.up.railway.app --project-ref your_project_ref
   ```
...
**URL:**
```
https://your_project_ref.functions.supabase.co/trigger-composite-stitch
```
...
```bash
curl -X POST "https://your-railway-service.up.railway.app/stitch" \
...
### Test Edge Function
```bash
curl -X POST "https://your_project_ref.functions.supabase.co/trigger-composite-stitch" \
  -H "Content-Type: application/json" \
...
### Railway
- **Service URL:** `https://your-railway-service.up.railway.app` (Generated by Railway)
- **GitHub Repo:** Your GitHub repository URL
- **Environment Variables:** Set in Railway Dashboard

### Supabase
- **Project Ref:** `your_project_ref` (from Supabase Dashboard)
- **Function URL:** `https://your_project_ref.functions.supabase.co/trigger-composite-stitch`
- **Anon Key:** Get from Supabase Dashboard → Settings → API (use in Spectacles app)
- **CLI Access Token:** Get from https://supabase.com/dashboard/account/tokens
