...
supabase secrets set STITCHER_SERVICE_URL=https://your-railway-service.up.railway.app
```
...
9. Add: `STITCHER_SERVICE_URL` = `https://your-railway-service.up.railway.app`
...
|----------|-------|---------|
| `STITCHER_SERVICE_URL` | `https://your-railway-service.up.railway.app` | Railway stitcher endpoint |
...
- Test Railway service: `curl https://your-railway-service.up.railway.app/health`
