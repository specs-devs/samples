...
export function spawnDetachedImageFrame(
  ...
  // Frame self-initializes on its OnStartEvent. Configure size/buttons and
  // attach content via onInitialized (a ReplayEvent), so frame.content and
  // frame.closeButton are guaranteed to exist when accessed.
