...
export class AgentsEmptyView {
  ...
  constructor(parent: SceneObject) {
    ...
    this.sceneObject = global.scene.createSceneObject("AgentsView");
    this.sceneObject.setParent(parent);

    const plateObj = global.scene.createSceneObject("AgentsPlate");
    ...
    createText({
      parent: this.sceneObject,
      name: "NoAgentsSubtext",
      text: "Connect an AI agent in Settings to start managing tasks from your Spectacles.",
      size: TextSize.M,
