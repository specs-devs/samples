...
export class UIManager {
  ...
  constructor(
    ...
    // Color clearing is governed by the render target (ColorRenderTarget.
    // clearColorOption) in the current API; the deprecated per-camera
    // enableClearColor defaulted to false anyway. This overlay camera shares
    // the main camera's render target and draws on top without re-clearing.
