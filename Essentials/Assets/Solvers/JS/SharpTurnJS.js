  ...
  function onUpdate() {
    ...
    if (getDistance(currentPos, _positions[_currentIndex]) > script.minVertexDistance) {
      ...
      if (_currentIndex >= script.step) {
        ...
        _newestDirection = subtractVectors(_positions[_currentIndex], _positions[prevIndex]);

        _oldestDirection = subtractVectors(_positions[_currentIndex], _positions[oldIndex]);
