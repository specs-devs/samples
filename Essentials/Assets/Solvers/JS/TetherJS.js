...
function TetherJS() {
  ...
  function calculateNewTargetPosition() {
    ...
    return new vec3(targetPos.x + script.offset.x, targetPos.y + script.offset.y, targetPos.z + script.offset.z);
  }
  ...
  function shouldReposition() {
    ...
    var toTarget = new vec3(myPos.x - targetPos.x, myPos.y - targetPos.y, myPos.z - targetPos.z);
    ...
    return (
      verticalDistance > script.verticalDistanceFromTarget || horizontalDistance > script.horizontalDistanceFromTarget
    );
  }
