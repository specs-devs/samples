...
export class ArcheryProjectileManagerTS extends BaseScriptComponent {
  ...
  onStart() {
    ...
    this.interactableManipulation.onInteractorTriggerStart.add(onTriggerStartCallback)
    this.interactableManipulation.onInteractorTriggerEnd.add(onTriggerEndCallback)
