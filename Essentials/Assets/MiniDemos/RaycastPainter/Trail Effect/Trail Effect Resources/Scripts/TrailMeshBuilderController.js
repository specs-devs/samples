...
function validateInputs() {
  ...
  if (!script.cursorBase) {
    print(
      "TrailMeshBuilderController, ERROR: Please make sure to set a sceneobject to represent the cursor start position."
    );
    return false;
  }
  if (!script.cursor) {
    print(
      "TrailMeshBuilderController, ERROR: Please make sure to set a sceneobject to represent the cursor end position."
    );
    return false;
  }
  return true;
